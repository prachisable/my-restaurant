...
const home = () => {
  const metadata = {
    ...
    description:
      "Experience the finest vegetarian cuisine at VeggieBite. From fast food favorites to traditional meals, we serve fresh, healthy, and delicious vegetarian dishes.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We`&apos;`re committed to serving you the freshest, healthiest,
              and most delicious vegetarian food
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                We source our vegetables and ingredients fresh daily from local
                organic farms
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Every dish is prepared with care and passion by our experienced
                chefs
              </p>
            </div>
          </div>
